...
Her oyuncunun skoru ve atış geçmişi ayrıdır. Sabit Round için temel kural kişi başı 5 şut; Endless kurtarışlarda da sürer. Sonuç/çıkış akışlarının son düzenlemesi Güncelleme Faz 3 kapsamındadır. Skor tabelası ve tam ekran saha Faz 4'te yenilenecek.
...
Mevcut Android APK eski sürümdür. Güncel oyunu Unity'de `Assets/Scenes/MainMenu.unity` sahnesinden Play ile inceleyebilirsiniz. Devir ekranını kapatıp ardından sol/orta/sağ bölgesine dokunun. Faz 2 için yeni APK üretilmedi.

Plan: `update-notes.md`. Rapor: `docs/update-faz-2-raporu.md`. Menü üreticisi **Penalty King → Updates → Phase 1 - Build menus**, devretme ekranı üreticisi **Phase 2 - Build turn handoff**. Eski gameplay üreticileri çalıştırılırsa sonrasında animasyon, ses ve güncel devir ekranı tekrar bağlanmalıdır.
